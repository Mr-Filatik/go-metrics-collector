...
func (s *Server) routes() {
	s.router.Get("/", http.HandlerFunc(s.GetAllMetrics))
	s.router.Get("/value/{type}/{name}", http.HandlerFunc(s.GetMetric))
	s.router.Post("/update/{type}/{name}/{value}", http.HandlerFunc(s.UpdateMetric))
}
