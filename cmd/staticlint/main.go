// Пакет main предоставляет multichecker для статического анализа Go-кода.
// Включает стандартные анализаторы, SA-анализаторы из staticcheck, анализаторы ST1000 и ST1023,
// публичные анализаторы (errcheck, single) и собственный анализатор osexit.
//
...
//   - ST1000 и ST1023  — проверка формата комментариев к пакетам
